...
class VirtualBankSystem {
    ...
    func checkBalance(bankAccount:BankAccount){
        switch accountType{
        case "credit": bankAccount.creditBalanceInfo;break;
        case "debit": bankAccount.debitBalanceInfo;break;
        default: break;
        }
    }
}
...
repeat{
    ...
    switch option{
    case 1: virtualBankSystem.checkBalance(bankAccount: bankAccount);break;
    case 2: virtualBankSystem.moneyTransfer(transferType: "withdraw", transferAmount: 10, bankAccount: &bankAccount);break;
    case 3: virtualBankSystem.moneyTransfer(transferType: "deposit", transferAmount: 10, bankAccount: &bankAccount);break;
    case 4: virtualBankSystem.isOpened = false; print("The system is closed");break;
    default: break;
    }
